...
ActiveRecord::Schema.define(version: 20161018142821) do
  ...
  create_table "share_values", force: :cascade do |t|
    ...
    t.string   "ExType",                     limit: 255
    t.string   "ExCoefficient",              limit: 255
  ...
  add_index "share_values", ["share_id"], name: "index_share_values_on_share_id", using: :btree

  create_table "shares", force: :cascade do |t|
    t.string   "name",          limit: 255
    t.string   "ShareSerial",   limit: 255
    t.string   "CompanySerial", limit: 255
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
  end
